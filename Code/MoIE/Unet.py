...
'''
@File    :   Unet.py
@Time    :   2024/11/11 18:00:18
@Author  :   Dunyuan XU
@Version :   0.1
@Desc    :   None
'''
'''
plain u-net implementation
'''
import torch
...
class Unet(nn.Module):
    def __init__(self):
        ...
        self.num_classes = 2  # output channels
...
class Unet_multi_outputs(nn.Module):
    def __init__(self, num_channels=3, num_classes=2):
        super(Unet_multi_outputs, self).__init__()
        self.num_filters = 32
        self.num_channels = num_channels  # input channels
        self.num_classes = num_classes  # output channels
        filters = [self.num_filters,
                   self.num_filters * 2,
                   self.num_filters * 4,
                   self.num_filters * 8,
    ...
    def forward(self, x):
        ...
        out = self.final(up_1)
        return out, {'conv1': conv1,'conv2': conv2,'conv3': conv3,'conv4': conv4}

# block for encoder in u-net
